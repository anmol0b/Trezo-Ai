  ...
  return (
    ...
    >
      ...
      <GradientLayer
        springX={springX}
        springY={springY}
        gradientColor={gradientColors[0] ?? "rgb(255, 100, 150)"}
        opacity={0.4}
        multiplier={1}
      />
      <GradientLayer
        springX={springX}
        springY={springY}
        gradientColor={gradientColors[1] ?? "rgb(100, 150, 255)"}
        opacity={0.3}
        multiplier={0.7}
      />
      <GradientLayer
        springX={springX}
        springY={springY}
        gradientColor={gradientColors[2]  ?? gradientColors[0] ?? "rgb(255, 200, 100)"}
        opacity={0.25}
        multiplier={1.2}
      />
