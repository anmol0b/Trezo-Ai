...
export const MobileNavHeader = ({
  ...
  return (
    <div
      className={cn(
        "flex w-full flex-row items-center justify-between rounded-xl px-1 py-1",
        className,
      )}
    >
      {children}
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className="theme-text" onClick={onClick} />
  ) : (
    <IconMenu2 className="theme-text" onClick={onClick} />
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "theme-text theme-border border bg-transparent shadow-none",
